        ...
        <nav className="navbar py-0">
            <div style={{backgroundColor: "#ffeeff"}} className="container-fluid py-1">
                ...
                <div className="d-flex align-items-center">
                    ...
                    <a href="https://github.com/GabrielSouzaCosta" rel="noreferrer" target="_blank"><img className="img-fluid pe-2" style={{maxWidth: "70px"}} src={`${process.env.PUBLIC_URL}/assets/images/github.png`} alt="" /></a>
                </div>
            </div>
        </nav>
    )
