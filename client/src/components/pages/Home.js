    ...
    return (
      ...
      <body style={{backgroundColor: "black"}}>
        <div className="container-fluid text-white">
                    <div className="bg-image vh-100" style={{backgroundImage: "url('assets/images/landingCat.png')", backgroundRepeat: "no-repeat", backgroundPosition: "left", backgroundSize: "50vh", backgroundBlendMode: "overlay"}}>
